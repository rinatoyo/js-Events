...
function lessContent(){
    // less.innerHTML = ''; This worked too though.
...
function newImage(){
    if(puggy.src === 'https://bit.ly//2Rh0vm4'){
        puggy.src = 'https://media.giphy.com/media/12pJ8OxSWwO86Y/giphy.gif';
    }else{
        puggy.src = 'https://bit.ly//2Rh0vm4'
    }
}
...
bio.addEventListener('click', aboutGrimace);

function aboutGrimace(){
    ...
    hobbiesElem.id = 'ProfileHobbies';
    hobbiesElem.innerHTML = 'Hobbies:' + grimace.hobbies.toString('');
    bio.appendChild(hobbiesElem);
}
...
secret.addEventListener('keyup', myPassword);
